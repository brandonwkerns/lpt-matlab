...
% Time settings
DN1 = datenum(year1,6,1,0,0,0);      % Set the starting time as a datenum.
DN2 = datenum(year2,6,30,21,0,0);    % Set the ending time as a datenum.
...
% Re-connect is applied after the individual tracking is done.
% Search for other
TRACKING_MAX_TIME_TO_RECONNECT = ACCUMULATION_PERIOD; % Max time between consecutive frames to connect CEs.
...
%%
SPLITTING_AND_MERGING_METHOD = 4;
