...
fout = (out_dir + '/rossby_system_tracks_20yrs__map_with_lpt.png')
...
leg = plt.legend((h00[0], h0[0], h1[0], h2[0],),('LPT','Westward LPT', 'Westward Start','Westward End',), loc=(0.0, 1.02),fancybox=True, fontsize=10, labelspacing=0.1)

plt.title('Westward LPT System Tracks: 1998 - 2018\n' + "(N = " + str(grand_total_rossby_count) + " westward systems, green; LPTs, gray)")
...
plt.title('Westward LPTs Track Density: 1998 - 2018')
