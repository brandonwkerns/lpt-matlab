...
PROCESSED_DATA_DIR_IN = ['../data/processed/thresh',num2str(FEATURE_THRESHOLD_VALUE),'/ceareas'];
PROCESSED_DATA_DIR_OUT = ['../data/processed/thresh',num2str(FEATURE_THRESHOLD_VALUE),'/timeclusters'];
