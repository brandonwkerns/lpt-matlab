...
fout = (out_dir + '/lpt_mjo_system_tracks_20yrs__map.png')
...
xt, yt = map(180.0, 40.0)

plt.text(xt, yt, ("N = " + str(grand_total_count) + "MJO\n" + "(of " + str(grand_total_lpt_count) + "LPTs)")  , fontsize=10, fontweight='bold')
